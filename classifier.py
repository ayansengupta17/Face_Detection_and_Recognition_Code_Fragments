...
def infer(args):
    ...
    if os.path.isfile('/home/itachi3/Documents/Research/codes/torch/openface_modified/demos/people.p'):
	with open('/home/itachi3/Documents/Research/codes/torch/openface_modified/demos/people.p', 'rb') as myfile:
		list_of_people=pickle.load(myfile)
		myfile.close()
    else:
		list_of_people=[]
    for img in args.imgs:
        ...
        if person not in list_of_people:
        	with open('/home/itachi3/Documents/Research/codes/torch/openface_modified/demos/people.p', 'wb') as myfile:
        		list_of_people.append(person)
        		pickle.dump(list_of_people, myfile)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=os.path.join(
            openfaceModelDir,
            'nn4.small2.v1.t7')) #CHANGE THIS LINE FOR CHANGING THE MODEL
